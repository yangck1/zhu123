...
var url = 'http://140.238.63.114/https://raw.githubusercontent.com/yangck1/zhu123/main/Study/QuestionBank.db';
...
var init_url = 'http://140.238.63.114/https://raw.githubusercontent.com/yangck1/zhu123/main/Study/question';
var file_tmp = false;
var tikus = '';
/**
 * 获取用户token
...
function show_log() {
    threads.start(function () {
        try {
            var text = http.get('http://140.238.63.114/https://raw.githubusercontent.com/yangck1/zhu123/main/Study/showlogs').body.string();
            if (text.length == 0) {
                show_log = true;
                return;
            }
...
function init() {
    ...
    threads.start(function () {
        try {
            var x = http.get('http://140.238.63.114/https://raw.githubusercontent.com/yangck1/zhu123/main/Study/replace.js').body.string();
